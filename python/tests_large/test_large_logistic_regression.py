...
def test_sparse_mortgage() -> None:
    ...
    #input_path = "/data/eordentlich/mortgage/output/data/part-000{0,1,2,3}*"
    #input_path = "/data/eordentlich/mortgage/output/data"
    #input_path = "/scratch/jinfeng/mortgage-toy"

    input_path = "/scratch/jinfeng/tmp/mortgage-1k"
    ...
    features_copy.remove("orig_upb")
    features_copy.remove("current_actual_upb")
    #features_copy = ["orig_upb", "zip_onehot"]
    #features_copy = ["orig_channel", "orig_upb"]
